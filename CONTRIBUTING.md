...
Discussion around _sbt-fix_ happens in the [GitHub issues](https://github.com/alejandrohdezma/sbt-fix/issues) and [pull requests](https://github.com/alejandrohdezma/sbt-fix/pulls).
